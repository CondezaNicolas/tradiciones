...
function formReducer(state: FormState, action: FormAction): FormState {
  switch (action.type) {
    ...
    case "setCover": return { ...state, imagenPortada: action.value };
    case "submit": return { ...state, isSubmitting: true, error: null };
    case "error": return { ...state, isSubmitting: false, error: action.text };
  }
}
